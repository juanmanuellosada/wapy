...
2. Aplicar `044_manual_sales.sql`: ampliación del `CHECK` de canal, `sold_at` con backfill desde `created_at`, `stock_applied` con default `true`, índice `(store_id, sold_at)`.
